...
<body>
  ...
  <div class="container py-4">
  	<h2 class="text-center font-weight-bold mb-0 pt-5" data-aos="zoom-in-up" data-aos-delay="300" data-aos-offset="0" data-aos-once="true">
	...
	<div class="row pt-5" data-aos="zoom-in-up" data-aos-delay="500" data-aos-offset="0" data-aos-once="true">
		<div class="col-md-8 col-12 mx-auto">
			<h1 class="large-address font-weight-bold rounded-pill text-center text-white bg-red t-40 px-md-0 px-2 py-4">台北市萬華區莒光路302號</h1>
        </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-3 col-6 px-md-0 px-4">
                    <a href="tel:(02)2302-5558" class="text-center hvr-bob">
                        <img src="./img/ic_large_phone.png" class="img-fluid px-md-0 px-3">
                ...
                <div class="col-md-3 col-6 px-md-0 px-4">
                    <a href="https://www.facebook.com/babyin1688/" class="text-center hvr-bob" target="_blank">
                        <img src="./img/ic_large_fb.png" class="img-fluid px-md-0 px-3">
                        <p class="t-22 font-weight-bold text-nowrap pt-2">點我連結</p>
                    </a>
                </div>
                <div class="col-md-3 col-6 px-md-0 px-4">
                    <a href="https://line.me/ti/p/@zfa7556c" class="text-center hvr-bob" target="_blank">
                        <img src="./img/ic_large_line.png" class="img-fluid px-md-0 px-3">
                        <p class="t-22 font-weight-bold text-nowrap pt-2">點我連結</p>
                    </a>
                </div>
                <div class="col-md-3 col-6 px-md-0 px-4">
                    <a href="https://www.instagram.com/a0908512899/" class="text-center hvr-bob" target="_blank">
                        <img src="./img/ic_large_ig.png" class="img-fluid px-md-0 px-3">
                        <p class="t-22 font-weight-bold text-nowrap pt-2">點我連結</p>
                    </a>
                </div>
            </div>
  ...
  <div class="container my-3">
	...
	<div class="row mx-auto my-5"style="overflow-x: hidden; overflow-y: hidden;">
	  <div class="col-md-12 col-sm-12 py-2" data-aos="zoom-in-right" data-aos-offset="0" data-aos-once="true">
		<h2 class="text-dark font-weight-bold"><img src="./img/logo_red.png"></h2>
		<p class="text-justify mb-1">您好 歡迎來店挑選，我們將會有專人為您服務<span class="px-3">|</span> 營業時間 : 上午09:00~晚上21:00(全年無休)</p>
