		...
		<div class="col-md-12 col-sm-12 col-xs-12"><div class="x_panel" style="height: auto;"><div class="x_title">
			...
			<form class="form-horizontal form-label-left" method="post" action="proc.php" enctype="multipart/form-data" onsubmit="return checkform();">
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12">帳號</label>
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input name="acc" type="text" class="form-control" placeholder="" value="<?=$ary_data['acc']?>" autocomplete="off" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input name="pwd" type="text" class="form-control" placeholder="" value="" autocomplete="off" >
					</div>
				</div>
