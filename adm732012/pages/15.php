...
$ary_data = $obj_banner->fetchAll(' * ', " type = '4' ORDER BY sort DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_banner->num / $pageNum), "index.php?c=".$ary_get['c']."&t=".$htmlSelect);
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <a data-fancybox data-type="iframe" data-src="proc.php?proc=add&c=<?=$ary_get['c']?>" class="btn btn-round btn-primary" style="float: right;">
              新增
            </a>
