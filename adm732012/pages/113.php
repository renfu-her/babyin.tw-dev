...
$ary_category = $obj_faq_category->fetchAll('*' , " pkey != '0' order by sort DESC ");
...
$ary_data = $obj_faq->fetchAll(' * ', "
													data_pkey = '".$sqlQuery."'
                                                    ORDER BY sort DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_faq->num / $pageNum), "index.php?c=".$ary_get['c']."&t=".$htmlSelect);
