...
$ary_data = $obj_category->fetchAll(' * ', " data_pkey = '0' order by sort DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_category->num / $pageNum), "index.php?c=".$ary_get['c']."&t=".$htmlSelect);
