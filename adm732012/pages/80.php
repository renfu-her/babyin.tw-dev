...
$ary_data = $obj_admin->fetchAll(' * ', " pkey != '0' ORDER BY pkey DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_admin->num / $pageNum), "index.php?c=".$ary_get['c']."");
