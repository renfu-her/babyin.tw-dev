...
$ary_data = $obj_products_select->fetchAll(' * ', " type = '2' ORDER BY sort DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_products_select->num / $pageNum), "index.php?c=".$ary_get['c']."");
