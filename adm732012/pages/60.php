...
$ary_data = $obj_news->fetchAll(' * ', " is_brand = '0' ORDER BY newsdate DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_news->num / $pageNum), "index.php?c=".$ary_get['c']."");
