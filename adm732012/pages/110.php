...
$ary_data = $obj_faq_category->fetchAll_join(' * ', " order by sort DESC ",True , array($pageNow-1 , $pageNum));

$htmlPage = paginateAdmin($pageNow, ceil($obj_faq_category->num / $pageNum), "index.php?c=".$ary_get['c']."&t=".$htmlSelect);
